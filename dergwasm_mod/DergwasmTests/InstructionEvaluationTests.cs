...
namespace Derg
{
    ...
    public class InstructionEvaluationTests
    {
        ...
        {
            return new UnflattenedInstruction(type, 
        ...
        private UnflattenedInstruction I32Const(int v) => Insn(InstructionType.I32_CONST, new Value(v));
        ...
        {
            return new UnflattenedInstruction(InstructionType.BLOCK, new UnflattenedOperand[]
            {
        ...
        private UnflattenedInstruction I32Block(params UnflattenedInstruction[] instructions)
        {
            ...
            {
                new UnflattenedBlockOperand(
                    new Value(0UL, (ulong)BlockType.RETURNING_BLOCK | (ulong)ValueType.I32 << 2),
                    new List<UnflattenedInstruction>(instructions),
                    new List<UnflattenedInstruction>()),
            });
        }
        ...
        public void TestI32Const()
        {
            ...
            Assert.Equal(101, machine.CurrentPC());
            Assert.Collection(machine.value_stack,
        ...
        public void TestBlock()
        {
            ...
            Assert.Equal(101, machine.CurrentPC());
            Assert.Equal(0, machine.StackLevel());
            Assert.Collection(machine.label_stack,
                e => Assert.Equal(new Label(/*arity=*/0, /*target=*/103, /*stack_level=*/0), e)
            );
        }
        ...
        public void TestI32Block()
        {
            ...
            Assert.Equal(0, machine.StackLevel());
            Assert.Collection(machine.label_stack,
                e => Assert.Equal(new Label(/*arity=*/1, /*target=*/103, /*stack_level=*/0), e)
            );
        }
